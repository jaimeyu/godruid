...
type IngestionDictionaryData struct {
	...
	VendorMap             map[string]*IngestionDictionaryData_MetricMap `protobuf:"bytes,2,rep,name=vendorMap" json:"vendorMap,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	CreatedTimestamp      int64                                         `protobuf:"varint,10,opt,name=createdTimestamp" json:"createdTimestamp,omitempty"`
	LastModifiedTimestamp int64                                         `protobuf:"varint,11,opt,name=lastModifiedTimestamp" json:"lastModifiedTimestamp,omitempty"`
}
...
func (m *IngestionDictionaryData) GetVendorMap() map[string]*IngestionDictionaryData_MetricMap {
	if m != nil {
		return m.VendorMap
	}
	return nil
...
var fileDescriptor1 = []byte{
	...
	,
}
