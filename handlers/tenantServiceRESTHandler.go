...
func CreateTenantServiceRESTHandler() *TenantServiceRESTHandler {
	...
	result.routes = []server.Route{
		server.Route{
			...
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.CreateTenantUser),
		},
		server.Route{
			Name:        "UpdateTenantUser",
			Method:      "PUT",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "users",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.UpdateTenantUser),
		},
		server.Route{
			Name:        "PatchTenantUser",
			Method:      "PATCH",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "users",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.PatchTenantUser),
		},
		server.Route{
			Name:        "GetTenantUser",
			Method:      "GET",
		...
		server.Route{
			...
			Method:      "DELETE",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "users/{userID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.DeleteTenantUser),
		},
		server.Route{
		...
		server.Route{
			...
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.CreateTenantDomain),
		},
		server.Route{
			Name:        "UpdateTenantDomain",
			Method:      "PUT",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "domains/{domainID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.UpdateTenantDomain),
		},
		server.Route{
			Name:        "PatchTenantDomain",
			Method:      "PATCH",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "domains/{domainID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.PatchTenantDomain),
		},
		server.Route{
		...
		server.Route{
			...
			Method:      "DELETE",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "domains/{domainID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.DeleteTenantDomain),
		},
		server.Route{
		...
		server.Route{
			...
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.CreateTenantConnectorConfig),
		},
		server.Route{
			Name:        "UpdateTenantConnectorConfig",
			Method:      "PUT",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "connector-configs",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.UpdateTenantConnectorConfig),
		},
		server.Route{
		...
		server.Route{
			...
			Method:      "DELETE",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "connector-configs/{connectorID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.DeleteTenantConnectorConfig),
		},
		server.Route{
		...
		server.Route{
			...
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.CreateTenantConnectorInstance),
		},
		server.Route{
			Name:        "UpdateTenantConnectorInstance",
			Method:      "PUT",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "connector-instances",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.UpdateTenantConnectorInstance),
		},
		server.Route{
		...
		server.Route{
			...
			Method:      "DELETE",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "connector-instances/{connectorID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.DeleteTenantConnectorInstance),
		},
		server.Route{
		...
		server.Route{
			...
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.CreateTenantIngestionProfile),
		},
		server.Route{
			Name:        "UpdateTenantIngestionProfile",
			Method:      "PUT",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "ingestion-profiles",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.UpdateTenantIngestionProfile),
		},
		server.Route{
			Name:        "PatchTenantIngestionProfile",
			Method:      "PATCH",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "ingestion-profiles",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.PatchTenantIngestionProfile),
		},
		server.Route{
		...
		server.Route{
			...
			Method:      "DELETE",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "ingestion-profiles/{dataID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.DeleteTenantIngestionProfile),
		},
		server.Route{
		...
		server.Route{
			...
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.CreateTenantThresholdProfile),
		},
		server.Route{
			Name:        "UpdateTenantThresholdProfile",
			Method:      "PUT",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "threshold-profiles",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.UpdateTenantThresholdProfile),
		},
		server.Route{
			Name:        "PatchTenantThresholdProfile",
			Method:      "PATCH",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "threshold-profiles",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.PatchTenantThresholdProfile),
		},
		server.Route{
		...
		server.Route{
			...
			Method:      "DELETE",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "threshold-profiles/{dataID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.DeleteTenantThresholdProfile),
		},
		server.Route{
		...
		server.Route{
			...
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.CreateMonitoredObject),
		},
		server.Route{
			Name:        "BulkInsertMonitoredObject",
			Method:      "POST",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "bulk/insert/monitored-objects",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.BulkInsertMonitoredObject),
		},
		server.Route{
			Name:        "BulkUpdateMonitoredObject",
			Method:      "PUT",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "bulk/insert/monitored-objects",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.BulkUpdateMonitoredObject),
		},
		server.Route{
			Name:        "UpdateMonitoredObject",
			Method:      "PUT",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "monitored-objects",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.UpdateMonitoredObject),
		},
		server.Route{
			Name:        "PatchMonitoredObject",
			Method:      "PATCH",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "monitored-objects",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.PatchMonitoredObject),
		},
		server.Route{
		...
		server.Route{
			...
			Method:      "DELETE",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "monitored-objects/{dataID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.DeleteMonitoredObject),
		},
		server.Route{
		...
		server.Route{
			...
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.CreateTenantMeta),
		},
		server.Route{
			Name:        "PatchTenantMeta",
			Method:      "PATCH",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "meta",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.PatchTenantMeta),
		},
		server.Route{
			Name:        "UpdateTenantMeta",
			Method:      "PUT",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "meta",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.UpdateTenantMeta),
		},
		server.Route{
			Name:        "GetTenantMeta",
			Method:      "GET",
		...
		server.Route{
			...
			Method:      "DELETE",
			Pattern:     apiV1Prefix + tenantsAPIPrefix + "meta",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.DeleteTenantMeta),
		},
		server.Route{
			Name:        "CreateReportScheduleConfig",
			Method:      "POST",
			Pattern:     apiV1Prefix + "tenants/{tenantID}/report-schedule-configs",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.CreateReportScheduleConfig),
		},
		server.Route{
			Name:        "UpdateReportScheduleConfig",
			Method:      "PUT",
			Pattern:     apiV1Prefix + "tenants/{tenantID}/report-schedule-configs",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.UpdateReportScheduleConfig),
		},
		server.Route{
			Name:        "GetReportScheduleConfig",
			Method:      "GET",
			Pattern:     apiV1Prefix + "tenants/{tenantID}/report-schedule-configs/{configID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.GetReportScheduleConfig),
		},
		server.Route{
			Name:        "DeleteReportScheduleConfig",
			Method:      "DELETE",
			Pattern:     apiV1Prefix + "tenants/{tenantID}/report-schedule-configs/{configID}",
			HandlerFunc: BuildRouteHandler([]string{userRoleSkylight, userRoleTenantAdmin}, result.DeleteReportScheduleConfig),
		},
		server.Route{
