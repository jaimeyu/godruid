...
func configureTenantServiceV2API(api *operations.GatherAPI, tenantDB datastore.TenantServiceDatastore, metricsDB datastore.MetricsDatastore) {
	...
	api.TenantProvisioningServiceV2BulkInsertMonitoredObjectsMetaV2Handler = tenant_provisioning_service_v2.BulkInsertMonitoredObjectsMetaV2HandlerFunc(handlers.HandleBulkInsertMonitoredObjectsMetaV2(handlers.SkylightAndTenantAdminRoles, tenantDB))
