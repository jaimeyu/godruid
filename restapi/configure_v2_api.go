...
func configureTenantServiceV2API(api *operations.GatherAPI, tenantDB datastore.TenantServiceDatastore, metricsDB datastore.MetricsDatastore) {
	...
	metricBaselineBulkUpdateManager := handlers.CreateMetricBaselineBulkUpdateManager(tenantDB)
	api.TenantProvisioningServiceV2BulkUpdateMetricBaselinesV2Handler = tenant_provisioning_service_v2.BulkUpdateMetricBaselinesV2HandlerFunc(handlers.HandleBulkUpdateMetricBaselinesV2(handlers.SkylightAdminRoleOnly, tenantDB, metricBaselineBulkUpdateManager))
