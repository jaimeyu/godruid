...
func configureTenantMetricBaselineServiceV2API(api *operations.GatherAPI, metricBaselineDatastore datastore.TenantMetricBaselineDatastore) {
	...
	api.TenantProvisioningServiceV2GetMetricBaselineByMonitoredObjectIDForHourOfWeekV2Handler = tenant_provisioning_service_v2.GetMetricBaselineByMonitoredObjectIDForHourOfWeekV2HandlerFunc(handlers.HandleGetMetricBaselineByMonitoredObjectIdForHourOfWeekV2(handlers.AllRoles, metricBaselineDatastore))
