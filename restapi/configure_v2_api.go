...
func configureAdminServiceV2API(api *operations.GatherAPI, adminDB datastore.AdminServiceDatastore, tenantDB datastore.TenantServiceDatastore, metricBaselineDatastore datastore.TenantMetricBaselineDatastore) {
	api.AdminProvisioningServiceV2CreateTenantV2Handler = admin_provisioning_service_v2.CreateTenantV2HandlerFunc(handlers.HandleCreateTenantV2(handlers.SkylightAdminRoleOnly, adminDB, tenantDB, metricBaselineDatastore))
	...
	api.AdminProvisioningServiceV2DeleteTenantV2Handler = admin_provisioning_service_v2.DeleteTenantV2HandlerFunc(handlers.HandleDeleteTenantV2(handlers.SkylightAdminRoleOnly, adminDB, metricBaselineDatastore))
...
func configureTenantServiceV2API(api *operations.GatherAPI, tenantDB datastore.TenantServiceDatastore, metricsDB datastore.MetricsDatastore) {
	...
	api.TenantProvisioningServiceV2CreateMonitoredObjectV2Handler = tenant_provisioning_service_v2.CreateMonitoredObjectV2HandlerFunc(handlers.HandleCreateMonitoredObjectV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2UpdateMonitoredObjectV2Handler = tenant_provisioning_service_v2.UpdateMonitoredObjectV2HandlerFunc(handlers.HandleUpdateMonitoredObjectV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2DeleteMonitoredObjectV2Handler = tenant_provisioning_service_v2.DeleteMonitoredObjectV2HandlerFunc(handlers.HandleDeleteMonitoredObjectV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2BulkInsertMonitoredObjectsV2Handler = tenant_provisioning_service_v2.BulkInsertMonitoredObjectsV2HandlerFunc(handlers.HandleBulkCreateMonitoredObjectsV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2BulkUpdateMonitoredObjectsV2Handler = tenant_provisioning_service_v2.BulkUpdateMonitoredObjectsV2HandlerFunc(handlers.HandleBulkUpdateMonitoredObjectsV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2BulkInsertMonitoredObjectsMetaV2Handler = tenant_provisioning_service_v2.BulkInsertMonitoredObjectsMetaV2HandlerFunc(handlers.HandleBulkInsertMonitoredObjectsMetaV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2BulkPatchMonitoredObjectsV2Handler = tenant_provisioning_service_v2.BulkPatchMonitoredObjectsV2HandlerFunc(handlers.HandleBulkPatchMonitoredObjectsV2(handlers.AdminAndContributorRoles, tenantDB))
	...
	api.TenantProvisioningServiceV2CreateReportScheduleConfigV2Handler = tenant_provisioning_service_v2.CreateReportScheduleConfigV2HandlerFunc(handlers.HandleCreateReportScheduleConfigV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2UpdateReportScheduleConfigV2Handler = tenant_provisioning_service_v2.UpdateReportScheduleConfigV2HandlerFunc(handlers.HandleUpdateReportScheduleConfigV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2DeleteReportScheduleConfigV2Handler = tenant_provisioning_service_v2.DeleteReportScheduleConfigV2HandlerFunc(handlers.HandleDeleteReportScheduleConfigV2(handlers.AdminAndContributorRoles, tenantDB))
	...
	api.TenantProvisioningServiceV2CreateDashboardV2Handler = tenant_provisioning_service_v2.CreateDashboardV2HandlerFunc(handlers.HandleCreateDashboardV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2UpdateDashboardV2Handler = tenant_provisioning_service_v2.UpdateDashboardV2HandlerFunc(handlers.HandleUpdateDashboardV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2DeleteDashboardV2Handler = tenant_provisioning_service_v2.DeleteDashboardV2HandlerFunc(handlers.HandleDeleteDashboardV2(handlers.AdminAndContributorRoles, tenantDB))
	...
	api.TenantProvisioningServiceV2CreateCardV2Handler = tenant_provisioning_service_v2.CreateCardV2HandlerFunc(handlers.HandleCreateCardV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2UpdateCardV2Handler = tenant_provisioning_service_v2.UpdateCardV2HandlerFunc(handlers.HandleUpdateCardV2(handlers.AdminAndContributorRoles, tenantDB))
	api.TenantProvisioningServiceV2DeleteCardV2Handler = tenant_provisioning_service_v2.DeleteCardV2HandlerFunc(handlers.HandleDeleteCardV2(handlers.AdminAndContributorRoles, tenantDB))
	...
	api.TenantProvisioningServiceV2UpdateMetadataConfigV2Handler = tenant_provisioning_service_v2.UpdateMetadataConfigV2HandlerFunc(handlers.HandleUpdateMetadataConfigV2(handlers.AdminAndContributorRoles, tenantDB))
...
func configureTenantMetricBaselineServiceV2API(api *operations.GatherAPI, metricBaselineDatastore datastore.TenantMetricBaselineDatastore) {
	...
	api.TenantProvisioningServiceV2UpdateMetricBaselineV2Handler = tenant_provisioning_service_v2.UpdateMetricBaselineV2HandlerFunc(handlers.HandleUpdateMetricBaselineV2(handlers.SkylightAndTenantAdminRoles, metricBaselineDatastore))
	api.TenantProvisioningServiceV2DeleteMetricBaselineV2Handler = tenant_provisioning_service_v2.DeleteMetricBaselineV2HandlerFunc(handlers.HandleDeleteMetricBaselineV2(handlers.SkylightAdminRoleOnly, metricBaselineDatastore))
	api.TenantProvisioningServiceV2UpdateMetricBaselineForHourOfWeekV2Handler = tenant_provisioning_service_v2.UpdateMetricBaselineForHourOfWeekV2HandlerFunc(handlers.HandleUpdateMetricBaselineForHourOfWeekV2(handlers.SkylightAdminRoleOnly, metricBaselineDatastore))
	api.TenantProvisioningServiceV2GetMetricBaselineByMonitoredObjectIDV2Handler = tenant_provisioning_service_v2.GetMetricBaselineByMonitoredObjectIDV2HandlerFunc(handlers.HandleGetMetricBaselineByMonitoredObjectIDV2(handlers.AllRoles, metricBaselineDatastore))
	api.TenantProvisioningServiceV2DeleteMetricBaselineByMonitoredObjectIDV2Handler = tenant_provisioning_service_v2.DeleteMetricBaselineByMonitoredObjectIDV2HandlerFunc(handlers.HandleDeleteMetricBaselineByMonitoredObjectIDV2(handlers.AllRoles, metricBaselineDatastore))

	metricBaselineBulkUpdateManager := handlers.CreateMetricBaselineBulkUpdateManager(metricBaselineDatastore)
	metricBaselineFetchLimiter := handlers.CreateLimitedFetchManager(metricBaselineDatastore)
	api.TenantProvisioningServiceV2BulkUpdateMetricBaselinesV2Handler = tenant_provisioning_service_v2.BulkUpdateMetricBaselinesV2HandlerFunc(handlers.HandleBulkUpdateMetricBaselinesV2(handlers.SkylightAdminRoleOnly, metricBaselineDatastore, metricBaselineBulkUpdateManager))
	api.TenantProvisioningServiceV2GetMetricBaselineByMonitoredObjectIDForHourOfWeekV2Handler = tenant_provisioning_service_v2.GetMetricBaselineByMonitoredObjectIDForHourOfWeekV2HandlerFunc(handlers.HandleGetMetricBaselineByMonitoredObjectIdForHourOfWeekV2(handlers.AllRoles, metricBaselineDatastore, metricBaselineFetchLimiter))
