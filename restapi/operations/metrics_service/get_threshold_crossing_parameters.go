...
// NewGetThresholdCrossingParams creates a new GetThresholdCrossingParams object
// no default values defined in spec.
func NewGetThresholdCrossingParams() GetThresholdCrossingParams {

	return GetThresholdCrossingParams{}
}

// GetThresholdCrossingParams contains all the bound params for the get threshold crossing operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetThresholdCrossing
type GetThresholdCrossingParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetThresholdCrossingParams() beforehand.
func (o *GetThresholdCrossingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
