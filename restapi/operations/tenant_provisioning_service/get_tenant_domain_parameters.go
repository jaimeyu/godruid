...
// NewGetTenantDomainParams creates a new GetTenantDomainParams object
// no default values defined in spec.
func NewGetTenantDomainParams() GetTenantDomainParams {

	return GetTenantDomainParams{}
}

// GetTenantDomainParams contains all the bound params for the get tenant domain operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetTenantDomain
...
//
// To ensure default values, the struct must have been initialized with NewGetTenantDomainParams() beforehand.
func (o *GetTenantDomainParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
