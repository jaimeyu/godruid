...
// NewPatchTenantMetadataParams creates a new PatchTenantMetadataParams object
// no default values defined in spec.
func NewPatchTenantMetadataParams() PatchTenantMetadataParams {

	return PatchTenantMetadataParams{}
}
...
//
// To ensure default values, the struct must have been initialized with NewPatchTenantMetadataParams() beforehand.
func (o *PatchTenantMetadataParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
