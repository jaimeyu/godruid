...
// TenantUpdateRequest The request used when updating an existing Tenant in Datahub
// swagger:model TenantUpdateRequest
type TenantUpdateRequest struct {

	// data
	// Required: true
	Data *TenantUpdateObject `json:"data"`
}
...
func (m *TenantUpdateRequest) validateData(formats strfmt.Registry) error {
